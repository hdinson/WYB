package com.zjta.wyb.widget.bottomrarlayout;
...
public class BottomBarLayout extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private HashMap<Integer, View> mOtherViews = new HashMap<>();
    ...
    private void init() {
        ...
        for (int i = 0; i < mChildCount; i++) {
            if (getChildAt(i) instanceof BottomBarItem) {
                ...
                //设置点击监听
                bottomBarItem.setOnClickListener(new MyOnClickListener(i - mOtherViews.size()));
            } else {
                //throw new IllegalArgumentException("BottomBarLayout的子View必须是BottomBarItem");
                View otherView = getChildAt(i);
                mOtherViews.put(i, otherView);
                otherView.setOnClickListener(new OtherViewCLick(i));
            }
        }

        if (mCurrentItem < mItemViews.size())
            mItemViews.get(mCurrentItem)
                      .refreshTab(true);
    ...
    private class MyOnClickListener implements OnClickListener {
        ...
        static final long TIME_INTERVAL = 1000L;
        ...
        public void onClick(View v) {
            ...
            if (nowTime - mLastClickTime > TIME_INTERVAL) {
                if (mOnItemClickedListener != null) {
                    boolean b = mOnItemClickedListener.onItemSelected(getBottomItem(currentIndex), mCurrentItem, currentIndex);
                    if (!b) return;
                }
    ...
    private OnOtherViewClickListener mListener = null;

    public void setOnOtherViewClickListener(OnOtherViewClickListener listener) {
        mListener = listener;
    }

    private class OtherViewCLick implements OnClickListener {

        private int currentIndex;

        OtherViewCLick(int i) {
            this.currentIndex = i;
        }
        ...
        public void onClick(View view) {
            if (mListener != null) {
                mListener.onOtherViewClick(currentIndex, view);
            }
        }
    }
    ...
    public interface OnItemClickedListener {
        boolean onItemSelected(BottomBarItem bottomBarItem, int previousPosition, int currentPosition);
    }
